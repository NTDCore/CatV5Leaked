...
local function GetScript(scripturl)
	if shared.VapeDeveloper then
		...
		local res = game:HttpGet("https://raw.githubusercontent.com/NTDCore/CatV5Leaked/main/"..scripturl, true)
...
if shared.VapeIndependent then
	...
	if shared.VapePrivate then
		if pcall(function() readfile("vapeprivate/"..game.PlaceId..".lua") end) then
			loadstring(readfile("vapeprivate/"..game.PlaceId..".lua"))()
		end	
	end
	GuiLibrary["LoadSettings"](shared.VapeCustomProfile)
	local profiles = {}
